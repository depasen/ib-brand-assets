...
const card=(a,c)=>{
  ...
  <div class="card-body">
    ...
    <div class="fields">
      ...
      <div class="field"><div class="flabel">Headline</div><p class="val">${e(fill(b.adHeadline))}</p></div>
      <div class="field"><div class="flabel">Description</div><p class="val">${e(fill(b.adDescription))}</p></div>
